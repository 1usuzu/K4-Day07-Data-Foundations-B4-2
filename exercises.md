...
**Step 3 — Thiết kế metadata schema:** Mỗi tài liệu cần `source_url`, `retrieved_at`, `document_version` và ít nhất 2 trường retrieval hữu ích (e.g., `category`, `customer_role`, `language`, `difficulty`).
